...
export const streams: FxStream[] = [
  ...
  // ---- Houses ------------------------------------------------------------
  // A house is a stream carrying `category: "house"` and nothing else changes
  // — same rooms, same tokens, same speaker requests. These four exist so the
  // demo can be walked end to end without a backend: somebody else's open
  // house, your own open house, your own house before you open it, and one
  // that has closed.
  {
    id: "st_house_rent",
    ownerId: "u_amara",
    title: "Lagos rent, honestly",
    description: "Bring a number. What are you actually paying, and where?",
    category: "house",
    status: "live",
    visibility: "public",
    ticketPriceKash: null,
  ...
  },
  {
    id: "st_house_mine",
    ownerId: ME_ID,
    title: "Sunday build club — what are you shipping?",
    description: "",
    category: "house",
    status: "live",
    visibility: "public",
  ...
  },
  {
    id: "st_house_soon",
    ownerId: ME_ID,
    title: "First house — testing the microphone",
    description: "",
    category: "house",
    status: "scheduled",
    visibility: "public",
  ...
  },
  {
    id: "st_house_closed",
    ownerId: "u_kenji",
    title: "Late night: the state of Nigerian fintech",
    description: "",
    category: "house",
    status: "ended",
    visibility: "public",
